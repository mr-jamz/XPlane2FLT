...
Version 9.4 rebuild: stationary/material-safe OpenFlight conversion, corrected
...
- Highlights the clicked OBJ8 object with a translucent, user-selectable color without hiding its texture.
